...
import type { Column, RowAction, GlobalAction } from './components/BetterTable';
...
function App() {
  const columns: Column<User>[] = [
    ...
    { id: 'rol', accessor: 'attributes.personal.rol', header: 'Rol', sortable: true, filterable: true },
    ...
    },
    {
      ...
      modalContent: ({ data }: { data: User }) => (
        <div>
          ...
          <p><strong>Rol:</strong> {data.attributes?.personal?.rol ?? 'N/A'}</p>
  ...
  return (
    <div className="App">
      ...
      <BetterTable<User>
        ...
        // selectable is auto-inferred from globalActions with requiresSelection
